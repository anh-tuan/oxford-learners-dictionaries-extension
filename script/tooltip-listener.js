...
/*
Add collocation onclick function
*/
...
/*
Add sound onclick function 
*/
OnclickFunction.playSound = function (btn) {
    var src_mp3 = btn.target.getAttribute("data-src-mp3");
    var src_ogg = btn.target.getAttribute("data-src-ogg");
